...
namespace Utage
{
	...
	public class UguiNovelTextCharacter
	{
		...
		public UguiNovelTextCharacter(CharData charData, UguiNovelTextGenerator generator )
		{
			...
			Font font = generator.NovelText.GetEffectiveFont();
			Init(charData, font, generator.NovelText.fontSize, bmpFontSize, generator.NovelText.fontStyle, generator.Space);
