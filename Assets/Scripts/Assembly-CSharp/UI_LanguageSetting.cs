...
public class UI_LanguageSetting : MonoBehaviour
{
	...
	private Utage.LanguageManagerBase subscribedLanguageManager;
	...
	private void InitText()
	{
		...
		text_curLanguage.text = ToDisplayName(languageManager.CurrentLanguage);
	}
	...
	private void OnClickBtn(bool isNext)
	{
		...
		LanguageManagerBase languageManager = LanguageManagerBase.Instance;
		string current = languageManager != null ? languageManager.CurrentLanguage : "";
	...
	private void InitializeLanguages()
	{
		...
		if (languageManager != null)
		{
			...
			AddLanguage(languageManager.CurrentLanguage);
			AddLanguage(languageManager.DefaultLanguage);
		}
	...
	private void SubscribeConfig()
	{
		...
		config.OnLoadValues.RemoveListener(CheckLanguageSetting);
		config.OnLoadValues.AddListener(CheckLanguageSetting);
	}
